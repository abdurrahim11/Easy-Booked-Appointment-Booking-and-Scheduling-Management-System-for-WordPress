            ...
            <tr>
                ...
                <td>
                    ...
                    if ( (int)$row->slots_type === 2 ) {
                        ...
                        <span class="abs-spaces-available-num-<?php echo esc_attr( $row->id ); ?>"><?php echo esc_html( $row->space_available + $row->booked_space ); ?></span>
                ...
                <td>
                    <div class="abs-custom-time-slots-remove" data-id="<?php echo esc_attr( $row->id ); ?>">
